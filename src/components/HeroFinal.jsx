        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-100 text-emerald-700 text-sm font-semibold rounded-full">
              ...
              Atendendo Brasília e Região
            </span>
          </motion.div>

          {/*Imagem serviço*/}
          <motion.img
            src="/assets/foto_servico.jpg"
            alt="Higienização profissional de estofados"
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="mx-auto mb-8 w-64 sm:w-72 lg:w-80 border border-gray-200 rounded-2xl shadow-md"
          />
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Atendimento em Brasília/DF</span>
            </div>
          </motion.div>
        </div>
      </div>
